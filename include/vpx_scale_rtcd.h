...
#include "sim-x86-64/vpx_scale_rtcd.h"
#else
#if TARGET_CPU_ARM64
#include "arm64/vpx_scale_rtcd.h"
#elif TARGET_CPU_ARM

#if __ARM_ARCH == 7
#include "armv7/vpx_scale_rtcd"
#elif __ARM_ARCH_7S__
#include "armv7s/vpx_scale_rtcd"
#endif // __ARM_ARCH

#elif TARGET_CPU_X86_64
#include "x86_64/vpx_scale_rtcd"
